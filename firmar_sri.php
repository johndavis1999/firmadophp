...
//rufa sin firmar
$ruta_no_firmados='facturas/sinfirmar/';
//nombre del xml a firmar
$nombrexml="2510202301099230287900110010010000004780314198012.xml";
...
$factura_firmada = new SignDOcumentToSRI('factura',$pathCertificate, $passwors, $contenido);
    

file_put_contents($rutafirmados.$nombrexml, $factura_firmada->xml);
